...
import com.bhcloud.jeefast.common.utils.PropertiesLoader;
import com.google.common.collect.Maps;
import com.jeefw.common.utils.PropertiesLoader;
...
public class Global {
	 ...
	 * 临时文件存放目录
	 */
	public static final String TEMP_DIR_NAME = USERFILES_BASE_URL + "__temp__";
	...
	public static String getUserfilesBaseDir() {
		...
		if (StringUtils.isBlank(dir)) {
			try {
				dir = ServletContextFactory.getServletContext().getRealPath(File.separator);//放到webapps根目录
			} catch (Exception e) {
				return "";
			}
		}
