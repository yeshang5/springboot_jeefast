package com.bhcloud.jeefast.common.utils.time;

import com.jeefw.common.utils.base.annotation.NotNull;
...
public class DateUtil {
     ...
     * 判断日期是否在范围内，包含相等的日期
     */
    public static boolean isBetween2(@NotNull final Date date, @NotNull final Date start, @NotNull final Date end) {
        boolean flag=false;
        if (date != null && start != null && end != null && start.before(end)) {
            flag=!date.before(start) && !date.after(end);
        }
        return flag;
    }
